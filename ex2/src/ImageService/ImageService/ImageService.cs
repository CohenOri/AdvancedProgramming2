...
namespace ImageService
{
...

    {
        ...
        public ImageService(string[] args)
        {
            ...
            AppCongigSettings.Instance.outPutDir = ConfigurationManager.AppSettings["OutputDir"];
            AppCongigSettings.Instance.thumbNail = Int32.Parse(ConfigurationManager.AppSettings["ThumbnailSize"]);
            AppCongigSettings.Instance.sourceName = ConfigurationManager.AppSettings["SourceName"];
            AppCongigSettings.Instance.logName = ConfigurationManager.AppSettings["ImageServiceLog"];


            //create logger server, modal. controller and server.
            this.modal = new ImageServiceModal(AppCongigSettings.Instance.outPutDir, AppCongigSettings.Instance.thumbNail);
            ...
            if (!System.Diagnostics.EventLog.SourceExists(AppCongigSettings.Instance.sourceName))
            {
                System.Diagnostics.EventLog.CreateEventSource(AppCongigSettings.Instance.sourceName, AppCongigSettings.Instance.logName);
            }
            ...
            eventLog1.Source = AppCongigSettings.Instance.sourceName;
            eventLog1.Log = AppCongigSettings.Instance.logName;
